...
export default function ReleaseTimelineItem({
  ...
  return (
    <li className="relative pl-10">
      <span className="absolute left-0 top-1.5 flex h-6 w-6 items-center justify-center rounded-full border-2 border-brand bg-white">
        <span className="h-2 w-2 rounded-full bg-brand" />
      </span>

      <details open={defaultOpen} className="group rounded-2xl border border-border-soft bg-white p-5 sm:p-6">
