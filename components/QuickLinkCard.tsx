...
export default function QuickLinkCard({
  ...
  return (
    <Link
      href={href}
      className="group flex flex-col rounded-2xl border border-border-soft bg-white p-6 shadow-sm transition-all hover:-translate-y-0.5 hover:border-brand hover:shadow-md"
    >
